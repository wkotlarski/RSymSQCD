...
XSection_Tree_MRSSM::XSection_Tree_MRSSM() {
...
int XSection_Tree_MRSSM::integrand(const int *ndim, const cubareal xx[],
 ...
 std::array<double, 3> XSection_Tree_MRSSM::integrate() {
