...
XSection_Virt_MRSSM::XSection_Virt_MRSSM() {
...
int XSection_Virt_MRSSM::integrand(const int *ndim, const cubareal xx[],
...
//////////////////////////////////////////////////////////////////////
 ...
 std::array<double, 3> XSection_Virt_MRSSM::integrate() {
