...
void print( string str, array<double,3> tree, array<double,3> virt, array<double,3> soft, array<double,3> hard) {
   ...
   cout << "---------------------------------------------------------------" << endl;
   cout << setprecision(5+offset);
   cout << setw(12) << "tree:" << setw(13+offset) << tree.at(0)
         << " +/- " << setprecision(1) << tree.at(1)
         << " fb ( p-value = " << setw(8) << tree.at(2) << " )\n";
   cout << setprecision(5+offset);
   cout << setw(12) << "virtual:" << setw(13+offset) << virt.at(0) << " +/- "
           << setprecision(1) << virt.at(1) << " fb ( p-value = "
           << setw(8) << virt.at(2) << " )\n";

      cout << setprecision(5+offset);
      cout << setw(12) << "real (soft):" << setw(13+offset) << soft.at(0) << " +/- " << setprecision(1) << soft.at(1)
           << " fb ( p-value = " << setw(8) << soft.at(2) << " )\n";
      cout << setprecision(5+offset);
      cout << setw(12) << "real (hard):" << setw(13+offset) << hard.at(0) << " +/- " << setprecision(1) << hard.at(1)
           << " fb ( p-value = " << setw(8) << hard.at(2) << " )\n";
      cout << "---------------------------------------------------------------" << endl;
      cout << setprecision(5+offset);
      cout << setw(12) << "sum:" << setw(13+offset)
