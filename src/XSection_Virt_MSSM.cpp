...
XSection_Virt_MSSM::XSection_Virt_MSSM() {
...
int XSection_Virt_MSSM::integrand(const int *ndim, const cubareal xx[],
...
// and with product of O(eps) prefactors of phase space and loop int        egral
 ...
 // loop integral
     Dminus4 = -2;
     SquaredMRealMinus2 = MsquaredRealMSSMVirt_uu_suLsuR(
                          pdf_nlo->alphasQ(MassSq), MassSq,
                          gluino_mass,T, s, U,
                          top_quark_mass, mu,
                          FiniteGs, Dminus4, Divergence);
...
//////////////////////////////////////////////////////////////////////
 ...
 std::array<double, 3> XSection_Virt_MSSM::integrate() {
