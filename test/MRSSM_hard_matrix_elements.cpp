...
TEST(MRSSMHardMatrixElementTest, BMP1) {
   ...
   EXPECT_NEAR(mrssm.matrixHard_gubar_suLsuLdaggerubar(alphas, p),    5.759140411059864e-05,  3e-15);
   EXPECT_NEAR(mrssm.matrixHard_gd_suLsuLdaggerd(alphas, p),    2.1304668849551822e-05,  1e-17);
