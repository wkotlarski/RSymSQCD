...
public:
   ...
   double BornME(std::vector<Particle>, EpsOrd, double, double) const noexcept;
...
private:
   ...
   double uubar_eebar_B(double, double) const noexcept;
   double uubar_eebar_CCB(int, int, EpsOrd, double, double) const noexcept;
   double uubar_eebar_V(EpsOrd, double, double) const noexcept;
   double uubar_eebarg (std::vector<Vec4D<double>> const&) const noexcept;
};
