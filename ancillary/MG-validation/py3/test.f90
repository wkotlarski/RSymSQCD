[% ' vim: syntax=golem
 %]program test
   ...
   do ievt = 1, NEVT
      ...
      vecs(1,:) = (/ 3000.0_ki, 0.0_ki, 0._ki, 3000._ki /)
      vecs(2,:) = (/ 3000.0_ki, 0.0_ki, 0._ki, -3000._ki /)
      vecs(3,:) = (/3000.0_ki, 2598.076211353316_ki * sin(1.9979610128050102613_ki), 0._ki, &
      2598.076211353316_ki*cos(1.9979610128050102613_ki)/)
      vecs(4,:) = (/3000._ki,  -2598.076211353316_ki *sin(1.9979610128050102613_ki), 0._ki, &
      -2598.076211353316_ki*cos(1.9979610128050102613_ki)/)

      scale2 = 1500._ki**2 !2.0_ki * dotproduct(vecs(1,:), vecs(2,:))
