...
// Process: g u > ul ur u~ NP=1 WEIGHTED=3 @1

//--------------------------------------------------------------------------
// Initialize process.

void Process_gu_ulurux::initProc(string param_card_name) 
{
...
void Process_gu_ulurux::sigmaKin() 
{
...
double Process_gu_ulurux::sigmaHat() 
{
...
void Process_gu_ulurux::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFS3C1_1(w[4], w[2], pars->GC_14, pars->mdl_MD3, pars->mdl_wdglu, w[6]); 
  FFS5C1_1(w[4], w[3], pars->GC_15, pars->mdl_MD3, pars->mdl_wdglu, w[7]); 
  VSS1_2(w[0], w[2], pars->GC_11, pars->mdl_msul, pars->ZERO, w[8]); 
  FFS5_2(w[1], w[3], pars->GC_15, pars->mdl_MD3, pars->mdl_wdglu, w[9]); 
  VSS1_2(w[0], w[3], pars->GC_11, pars->mdl_msur, pars->ZERO, w[10]); 
  FFS3C1_2(w[1], w[2], pars->GC_14, pars->mdl_MD3, pars->mdl_wdglu, w[11]); 
  FFV1C1_1(w[4], w[0], pars->GC_12, pars->ZERO, pars->ZERO, w[12]); 

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFS5_0(w[5], w[6], w[3], pars->GC_15, amp[0]); 
  FFS3C1_0(w[5], w[7], w[2], pars->GC_14, amp[1]); 
  FFS3C1_0(w[9], w[4], w[8], pars->GC_14, amp[2]); 
  FFS3C1_0(w[1], w[7], w[8], pars->GC_14, amp[3]); 
  FFS5C1_0(w[11], w[4], w[10], pars->GC_15, amp[4]); 
  FFS5_0(w[1], w[6], w[10], pars->GC_15, amp[5]); 
  FFS5C1_0(w[11], w[12], w[3], pars->GC_15, amp[6]); 
  FFS3C1_0(w[9], w[12], w[2], pars->GC_14, amp[7]); 
  FFV1C1_0(w[11], w[7], w[0], pars->GC_13, amp[8]); 
  FFV1_0(w[9], w[6], w[0], pars->GC_13, amp[9]); 

}
double Process_gu_ulurux::matrix_1_gu_ulurux() 
{
  int i, j; 
  // Local variables
